...
// DELETE /api/interactions/request/:targetUserId — cancel a sent request
router.delete('/request/:targetUserId', interactionController.cancel);

// DELETE /api/interactions/ally/:targetUserId — remove an existing ally
router.delete('/ally/:targetUserId', interactionController.removeAlly);

// GET /api/interactions/relationship/:targetUserId — bidirectional status
router.get('/relationship/:targetUserId', interactionController.relationship);

// GET /api/interactions/allies/:userId/count — must come before the
// plain /allies/:userId list route below
router.get('/allies/:userId/count', interactionController.alliesCount);

// GET /api/interactions/allies/:userId?cursor=&limit=
router.get('/allies/:userId', interactionController.listAllies);
