...
// GET /api/profiles/:userId/relationship — must come before the plain
// /:userId route below, same static-before-dynamic rule as the rest of
// this file.
router.get('/:userId/relationship', authMiddleware, profileController.getRelationship);
